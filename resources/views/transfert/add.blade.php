            ...
            <div class="content-header">
                <div class="container-fluid">
                    ...
                    <div class="col-sm-6">
                        ...
                        <li class="breadcrumb-item active"><a href="{{ route('transfert.index') }}" role="button" class="btn btn-success">LISTE D'ENREGISTREMENT DES TRANSFERTS</a></li>
        ...
        <form action="{{ route('transfert.store') }}" method="POST">
            @csrf
             <div class="card border-danger border-0">
                        <div class="card-header bg-success text-center">FORMULAIRE D'ENREGISTREMENT D'UNE TRANSFERT</div>
                            <div class="card-body">
                                @if ($errors->any())
